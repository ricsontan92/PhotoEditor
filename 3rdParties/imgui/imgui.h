...
namespace ImGui
{
    ...
    IMGUI_API void          Image(ImTextureID user_texture_id, const ImVec2& image_size, float aspect, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0));
    ...
    IMGUI_API bool          ImageButton(const char* str_id, ImTextureID user_texture_id, const ImVec2& image_size, float aspect, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1));
    ...
    IMGUI_API bool          IsMouseHoveringCircle(const ImVec2& center, float radius, bool clip = true);// is mouse hovering given bounding circle (in screen space). clipped by current clipping settings, but disregarding of other consideration of focus/window ordering/popup-block.
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledOutlined(const ImVec2& p_min, const ImVec2& p_max, ImU32 rectCol, ImU32 outlineCol, float rounding = 0.0f, ImDrawFlags flags = 0);                     // a: upper-left, b: lower-right (== upper-left + size)
